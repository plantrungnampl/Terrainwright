...
public record OperationIntent(
    ...
    public static OperationIntent prepared(
            ...
            OperationKind kind,
            List<OperationDelta> deltas) {
        return new OperationIntent(operationId, jobId, jobRevision, kind, OperationStatus.PREPARED, deltas);
    }

    public OperationIntent withStatus(OperationStatus nextStatus) {
        return new OperationIntent(operationId, jobId, jobRevision, kind, nextStatus, deltas);
    }
